...
public class DocumentoServiceTest {
    ...
    TipoDocumento tipoDocumentoTxt = new TipoDocumento();
    TipoDocumento tipoDocumentoPdf = new TipoDocumento();
    TipoDocumento tipoDocumentoImg = new TipoDocumento();
    ProcessarDocumentoDto processarDocumentoDtoTxt = new ProcessarDocumentoDto();
    ProcessarDocumentoDto processarDocumentoDtoPdf = new ProcessarDocumentoDto();
    ProcessarDocumentoDto processarDocumentoDtoImg = new ProcessarDocumentoDto();
    String base64Pdf = "";
    String base64Text = "";
    String base64Erro = "";
    String texto = "";
    ...
    public void init() {
        ...
        tipoDocumentoPdf.setId(1L);
        tipoDocumentoPdf.setNome("pdf");

        tipoDocumentoTxt.setId(1L);
        tipoDocumentoTxt.setNome("txt");

        tipoDocumentoImg.setId(1L);
        tipoDocumentoImg.setNome("img");
        ...
        base64Text = "QVJRVUlWTyBURVhUTyBERSBURVNURQ0KRXN0ZSDpIHVtIGFycXVpdm8gdHh0IHV0aWxpemFkbyBwYXJhIHRlc3RlcyBkZSBjb25zdWx0YSBkZSBhcnF1aXZvLg==";
        base64Erro = "jzbnasdiflbszdhfgbiDBOUAVFDbphbsdfodhfbHh0IHV0aWxpemFkbyBwYXJhIHRlc3RlcyBkZSBjb25zdWx0YSBkZSBhcnF1aXZvLg==";

        texto = "ARQUIVO PDF DE TESTE\n" +
                "Este é um arquivo pdf utilizado para testes de consulta de arquivo.";

        processarDocumentoDtoTxt.setIdTipoDocumento(1L);
        processarDocumentoDtoTxt.setIdTipoAplicacao(1L);
        processarDocumentoDtoTxt.setIdUsuario(1L);
        processarDocumentoDtoTxt.setDocumentoBase64(base64Text);

        processarDocumentoDtoPdf.setIdTipoDocumento(1L);
        processarDocumentoDtoPdf.setIdTipoAplicacao(1L);
        processarDocumentoDtoPdf.setIdUsuario(1L);
        processarDocumentoDtoPdf.setDocumentoBase64(base64Pdf);

        processarDocumentoDtoImg.setIdTipoDocumento(1L);
        processarDocumentoDtoImg.setIdTipoAplicacao(1L);
        processarDocumentoDtoImg.setIdUsuario(1L);
    }

    @Test
    public void verificaUsuarioExistenteComSucesso() {
        given(usuarioRepositorio.findById(anyLong()))
                .willReturn(Optional.of(usuario));

        documentoService.verificaUsuarioExistente(1L);

        verify(usuarioRepositorio, times(1)).findById(anyLong());
    }

    @Test(expected = BadRequestException.class)
    public void verificaUsuarioExistenteComFalha() {
        given(usuarioRepositorio.findById(anyLong()))
    ...
    @Test(expected = BadRequestException.class)
    public void obterTipoDocumentoComFalha() {
        given(tipoDocumentoRepositorio.findById(anyLong()))
                .willReturn(Optional.empty());

        documentoService.obterTipoDocumento(1L);

        verify(tipoDocumentoRepositorio, times(1)).findById(anyLong());
    }

    @Test
    public void verificarTipoDocumentoPermitidoComSucesso() {
        given(tipoUsuarioRepositorio.possuiPermissaoTipoDocumento(anyLong(), anyLong()))
                .willReturn(1);

        documentoService.verificarTipoDocumentoPermitido(1L, 1L);

        verify(tipoUsuarioRepositorio, times(1)).possuiPermissaoTipoDocumento(anyLong(), anyLong());
    }

    @Test(expected = ForbiddenException.class)
    public void verificarTipoDocumentoPermitidoComFalha() {
        given(tipoUsuarioRepositorio.possuiPermissaoTipoDocumento(anyLong(), anyLong()))
                .willReturn(0);
    ...
    @Test
    public void verificarTipoAplicacaoPermitidoComSucesso() {
        given(tipoUsuarioRepositorio.possuiPermissaoTipoAplicacao(anyLong(), anyLong()))
                .willReturn(1);

        documentoService.verificarTipoAplicacaoPermitido(1L, 1L);

        verify(tipoUsuarioRepositorio, times(1)).possuiPermissaoTipoAplicacao(anyLong(), anyLong());
    }

    @Test(expected = ForbiddenException.class)
    public void verificarTipoAplicacaoPermitidoComFalha() {
        given(tipoUsuarioRepositorio.possuiPermissaoTipoAplicacao(anyLong(), anyLong()))
                .willReturn(0);
    ...
    @Test()
    public void lerArquivoTxtComSucesso() {
        var result = documentoService.lerArquivoTxt(base64Text);

        assertNotNull(result);
    }

    @Test()
    public void separaTextoEmPalavrasComSucesso() {
        var result = documentoService.separaTextoEmPalavras(texto);

        assertNotNull(result);
    }

    @Test
    public void obterTipoDocumentoComSucesso() {
        given(tipoDocumentoRepositorio.findById(anyLong()))
                .willReturn(Optional.of(tipoDocumentoTxt));

        var result = documentoService.obterTipoDocumento(1L);
    ...
    @Test()
    public void mockImagemComSucesso(){
        var result = documentoService.mockImagem();
    ...
    @Test()
    public void contagemPalavrasTxtComSucesso(){
        given(tipoDocumentoRepositorio.findById(anyLong()))
                .willReturn(Optional.of(tipoDocumentoTxt));

        var result = documentoService.leituraArquivo(processarDocumentoDtoTxt);
    ...
    @Test()
    public void contagemPalavrasPDFComSucesso(){
        given(tipoDocumentoRepositorio.findById(anyLong()))
                .willReturn(Optional.of(tipoDocumentoPdf));

        var result = documentoService.leituraArquivo(processarDocumentoDtoPdf);
    ...
    @Test()
    public void contagemPalavrasImgComSucesso(){
        given(tipoDocumentoRepositorio.findById(anyLong()))
                .willReturn(Optional.of(tipoDocumentoImg));

        var result = documentoService.leituraArquivo(processarDocumentoDtoImg);
    ...
    @Test()
    public void processarDocumentoImgComSucesso(){
        given(tipoDocumentoRepositorio.findById(anyLong()))
                .willReturn(Optional.of(tipoDocumentoImg));
        ...
        var result = documentoService.processarDocumento(processarDocumentoDtoImg);
    ...
    @Test()
    public void processarDocumentoTxtComSucesso(){
        given(tipoDocumentoRepositorio.findById(anyLong()))
                .willReturn(Optional.of(tipoDocumentoTxt));
        ...
        var result = documentoService.processarDocumento(processarDocumentoDtoTxt);
    ...
    @Test()
    public void processarDocumentoPdfComSucesso(){
        given(tipoDocumentoRepositorio.findById(anyLong()))
                .willReturn(Optional.of(tipoDocumentoPdf));
        ...
        var result = documentoService.processarDocumento(processarDocumentoDtoPdf);
    ...
    @Test()
    public void processarTipoDocumentoInexistente(){
        tipoDocumentoPdf.setNome("aaaaaaa");
        given(tipoDocumentoRepositorio.findById(anyLong()))
                .willReturn(Optional.of(tipoDocumentoPdf));
